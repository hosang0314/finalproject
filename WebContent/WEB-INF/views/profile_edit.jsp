	...
	<div class="wrapper">
		<div class="main-header">
			<div class="logo-header">
				<a href="/town/main.do" class="logo">
					BEST for CHILD
				</a>
								...
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											...
											<a href="evaluation.html" class="btn btn-rounded btn-danger btn-sm">Evaluation</a></div>
										</div>
									</li>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="/town/profile.do"><i class="ti-user"></i> My Profile</a>
									<a class="dropdown-item" href="/town/profile_edit.do"></i> Edit Profile</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="/town/logout.do"><i class="fa fa-power-off"></i> Logout</a>
								</ul>
								<!-- /.dropdown-user -->
							</li>
						</ul>
				...
				<div class="scrollbar-inner sidebar-wrapper">
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample" aria-expanded="true" style="">
								<ul class="nav">
									<li>
										<a>
											<span class="link-collapse">FIRSTNAME: <%=cvo.getC_FIRSTNAME() %></span>
										</a>
									</li>
									<li>
										<a>
											<span class="link-collapse">LASTNAME : <%=cvo.getC_LASTNAME() %></span>
										</a>
									</li>
									<li>
										<a>
											<span class="link-collapse">E-MAIL   : <%=cvo.getC_ID() %></span>
										</a>
									</li>
									<li>
										<a>
											<span class="link-collapse">LOCATION : <%=cvo.getLO_NAME() %></span>
										</a>
									</li>
					...
					<ul class="nav">
						...
						<li class="nav-item active">
							<a href="evaluation_edit.do">
								<i class="la la-keyboard-o"></i>
								<p>UPDATE EVALUATION</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="profile_edit.do">
