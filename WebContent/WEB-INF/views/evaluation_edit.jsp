				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						%>
							...
							<a class="dropdown-item" href="edit.html"></i> Edit Profile</a>
							<div class="dropdown-divider"></div>
		...
		<div class="sidebar">
			<div class="scrollbar-inner sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="nav-item active"><a href="evaluation_edit.html">
							<i class="la la-keyboard-o"></i>
							<p>UPDATE EVALUATION</p>
					</a></li>
					<li class="nav-item"><a href="profile_edit.html"> <i
							class="la la-table"></i>
							<p>EDIT PROFILE</p>
					</a></li>
...
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////  -->
					...
					%>
					<form action="/town/updateEvaluation.do" method="get">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
